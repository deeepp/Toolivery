...
const mockTools: Tool[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1578255321055-d9ed6a976af5?auto=format&fit=crop&q=80&w=800',
    available: true,
  },
  {
    id: '4',
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {showChat && (
          <div className="fixed bottom-4 right-4 w-96 z-20">
            <Chat messages={messages} onSendMessage={handleSendMessage} setCartItems={setCartItems} />
          </div>
        )}
